...
import (
	...
	"github.com/sylr/go-libqd/config/example/config"
)
...
func (l *Logger) Tracef(format string, vals ...interface{}) {
	l.l.Tracef("go-libqd/config: "+format, vals...)
}

func (l *Logger) Debugf(format string, vals ...interface{}) {
	l.l.Debugf("go-libqd/config: "+format, vals...)
}

func (l *Logger) Infof(format string, vals ...interface{}) {
	l.l.Infof("go-libqd/config: "+format, vals...)
}

func (l *Logger) Warnf(format string, vals ...interface{}) {
	l.l.Warnf("go-libqd/config: "+format, vals...)
}

func (l *Logger) Errorf(format string, vals ...interface{}) {
	l.l.Errorf("go-libqd/config: "+format, vals...)
}

func (l *Logger) Fatalf(format string, vals ...interface{}) {
	l.l.Fatalf("go-libqd/config: "+format, vals...)
}
